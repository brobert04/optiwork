            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('/assets/img/background.jpg'); background-size: cover;">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                        <div class="card card-plain">
                            <div class="card-header">
                                <h4 class="font-weight-bolder" style="color:#071527">Welcome to Optiwork</h4>
                                <p class="mb-0">Enter your email and password to register</p>
                            </div>
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <a class="btn btn-outline-secondary" href="{{route('auth.redirect')}}" role="button" style="text-transform:none; width: 250px; font-weight: bold">
                                ...
                                <form class="mt-4" action="{{route('custom.register')}}" method="post">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        <input type="text" class="form-control form-control-border @error('name') is-invalid @enderror" placeholder="Full name" id="name" name="name" required>
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-lg btn-lg w-100 mt-4 mb-0" style="background-color:#ef6445; color:#071527">Sign Up</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-2 text-sm mx-auto">
                                    ...
                                    <a href="{{route('login')}}" class="font-weight-bold" style="color:#071527">Sign in</a>
                                </p>
                            </div>
                        </div>
                    </div>
